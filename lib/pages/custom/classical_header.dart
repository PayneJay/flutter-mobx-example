...
/// 经典Header
class QHHClassicalHeader extends Header {
  /// Key
  final Key key;
...
class _ClassicalHeaderWidget extends StatefulWidget {
  final QHHClassicalHeader classicalHeader;
  ...
  @override
  _ClassicalHeaderWidgetState createState() => _ClassicalHeaderWidgetState();
}

class _ClassicalHeaderWidgetState extends State<_ClassicalHeaderWidget>
    with TickerProviderStateMixin<_ClassicalHeaderWidget> {
  // 是否到达触发刷新距离
  ...
  IconData get _finishedIcon {
    if (!widget.showRefreshIcon) return null;
              ...
              child: Container(
                ...
                child: (widget.refreshState == RefreshMode.refresh ||
                    ...
                    ? Container(
                        ...
                        child: CircularProgressIndicator(
                          ...
                          valueColor: AlwaysStoppedAnimation(
                            widget.classicalHeader.refreshColor,
                          ),
                        ),
                      )
                    : widget.refreshState == RefreshMode.refreshed ||
                        ...
                        ? Icon(
                            _finishedIcon,
                            color: widget.classicalHeader.refreshColor,
                          )
                        : Transform.rotate(
                            child: Icon(
                              isReverse
