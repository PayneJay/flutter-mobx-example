...
/// 经典Footer
class QHHClassicalFooter extends Footer {
  /// Key
  final Key key;
...
class _ClassicalFooterWidget extends StatefulWidget {
  final QHHClassicalFooter classicalFooter;
  ...
  @override
  _ClassicalFooterWidgetState createState() => _ClassicalFooterWidgetState();
}

class _ClassicalFooterWidgetState extends State<_ClassicalFooterWidget>
    with TickerProviderStateMixin<_ClassicalFooterWidget> {
  // 是否到达触发加载距离
  ...
  IconData get _finishedIcon {
    if (!widget.showNoMoreIcon) return null;
              ...
              child: Container(
                ...
                child: (widget.loadState == LoadMode.load ||
                    ...
                    ? Container(
                        ...
                        child: CircularProgressIndicator(
                          ...
                          valueColor: AlwaysStoppedAnimation(
                            widget.classicalFooter.loadColor,
                          ),
                        ),
                      )
                    : widget.loadState == LoadMode.loaded ||
                        ...
                        ? Icon(
                            _finishedIcon,
                            color: widget.classicalFooter.loadColor,
                          )
                        : Transform.rotate(
                            child: Icon(
                              !isReverse
